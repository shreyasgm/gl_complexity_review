...
just go to [this link](ttps://www.dropbox.com/s/34a0tnboycvsnx0/country_hsproduct4digit_year.parquet) and download the data manually and read it in using `read_parquet`.
